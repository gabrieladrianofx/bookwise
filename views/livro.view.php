<p class="mt-4 font-bold text-lg text-stone-400">ID do Livro: <?= $livro->titulo ?></p>

<?php require '../partials/_livro.php'; ?>

<h2 class="font-bold text-lg text-stone-400">Avaliações</h2>
        ...
        <?php if (auth()): ?>
            <div class="border border-stone-700 rounded">
                ...
                <form class="p-4 space-y-4" method="POST" action="/avaliacao-criar">
                    ...
                    <div class="flex flex-col">
                        <label class="text-stone-400 mb-1" for="nota">Nota</label>
                        <select
                            name="nota"
